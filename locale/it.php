...
return array(
    ...
    "torrent_search_button" => "Cerca torrent con LibreY",
    ...
    "donate_original_developer" => "Fate una donazione allo sviluppatore originale di %s, un progetto che LibreY cerca di migliorare.",
    "donate_fork" => "Donare alla persona che ha fatto il fork di %s in LibreY",

    "api_unavailable" => "Questa API di LibreY non è al momento disponibile."
);
