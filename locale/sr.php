...
return array(
   ...
   "torrent_search_button" => "Претражи торенте са LibreY-ем",
   ...
   "donate_original_developer" => "Донирајте програмеру који је развио пројекат %s, који LibreY покушава да побољша",
   "donate_fork" => "Донирајте особи која је направила форк %s у LibreY",

   "api_unavailable" => "Овај LibreY API тренутно није доступан"
);
